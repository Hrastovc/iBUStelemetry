...
public:
  // public methods
  iBUStelemetry(uint8_t receivePin, uint8_t transmitPin, bool inverse_logic = false, bool full_duplex = true);
  ~iBUStelemetry();
  ...
  //iBUS
  void addSensor(byte type);
  void setSensorMeasurement(byte adr, float value);
